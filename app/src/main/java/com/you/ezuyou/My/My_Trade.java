...
public class My_Trade extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar my_history_toolbar = (Toolbar) findViewById(R.id.my_trade_toolbar);
    ...
    private void bindView() {
        ...
        //使用listview
        listView = (ListView) findViewById(R.id.my_trade_list);
        ...
        //下拉刷新
        swipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.my_trade_swip);
    ...
    //刷新
    public void flush() {
        Thread getHome_Item = new GetHome_Item(handler, -2, this);
        getHome_Item.start();
        try {
            getHome_Item.join();
