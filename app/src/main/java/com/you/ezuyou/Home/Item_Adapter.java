...
public class Item_Adapter extends BaseAdapter {
    ...
    public Item_Adapter(List<Home_Item> Data, Context context) {
        this.Data = Data;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView item_rent_icon = (ImageView) convertView.findViewById(R.id.home_item_item_rent_icon);
        ImageView item_sell_icon = (ImageView) convertView.findViewById(R.id.home_item_item_sell_icon);
